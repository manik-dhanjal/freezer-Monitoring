...
router.get("/",(req,res)=>
{
    ...
    db.query(sql,(err,result)=>
    {
      ...
      res.render("freezer.ejs",{allFreezer:result,allLiveFreezer:liveResult,success:req.flash("success"),error:req.flash("error")
      });
       })
    })
...
router.post("/freezer/add",(req,res)=>
{
    ...
    db.query(sql,newFreezer,(err,result)=>
    {
        ...
        db.query("INSERT INTO live_records SET?",{freezer_id:req.body.freezerId},(err,liveResult)=>
        { 
            if(err)
            {
            console.log(err);
