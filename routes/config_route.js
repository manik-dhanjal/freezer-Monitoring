...
router.get("/config", (req, res) => {
  ...
  db.query(sql, (err, freezertable) => {
    ...
    let sql2 =
      "Select a.freezer_name,b.alert_temperature, b.email_to from freezer_monitoring.freezer_data as a right join freezer_monitoring.alert_config as b on   b.freezer_id=a.freezer_id ;";
