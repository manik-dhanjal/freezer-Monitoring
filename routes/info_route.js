...
{   
    ...
    var chartData=[];
         ...
         await db.query(sql1,(err,result)=>
          {
            ...
            { 
               console.log(err);
               req.flash("error","Error while accessing Current Chart from Database !!!")
            }
         ...
         await db.query(sql1,async(err,result)=>
           {
            ...
            { 
               console.log(err);
               req.flash("error","Error while Current V/S Temperature Chart from Database !!!")
            }
                var trash = [];
      ...
      db.query(sql2,(err,result_live)=>
      {
         ...
         { 
            console.log(err);
            req.flash("error","Error while accessing live Temprature and Current from Database !!!")
         }
        ...
        result_live.forEach(freezer =>
         ...
         db.query(sql3,(err,alert)=>
         {
            ...
            { 
               console.log(err);
               req.flash("error","Error while accessing Freezer Alerts from Database !!!")
            }
        ...
        db.query(sql4,(err,result_data)=>
        {
          ...
          res.render("frezinfo.ejs",{freezer:arr,
